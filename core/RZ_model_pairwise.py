...
class UserModel_Pairwise(UserModel):
    ...
    def __init__(self, feature_columns, y_columns, task, task_logit_dim,
        ...
        self.fc1 = nn.Linear(dnn_hidden_units[-1], dnn_hidden_units[-1], bias=False)
        self.fc2 = nn.Linear(dnn_hidden_units[-1], 1, bias=False)
    ...
    def _deepfm(self, X, feature_columns, feature_index):
        ...
        # log_var = self.fc2(self.dropout(self.relu(self.fc1(dnn_output))))
    ...
    def get_loss(self, x, y, score):
        ...
        if self.ab_columns is None:
            ...
            #loss = self.loss_func(y, y_deepfm_pos, y_deepfm_neg, score, alpha_u=alpha_u, beta_i=beta_i, log_var=log_var_pos, log_var_neg=log_var_neg)
