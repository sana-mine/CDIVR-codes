...
def onpolicy_trainer(
        ...
        state_tracker: StateTrackerBase,
        max_epoch: int,
        step_per_epoch: int,
    ...
    best_reward, best_reward_std = test_result["NX_0_rew"], test_result["NX_0_rew_std"]
    ...
    for epoch in range(1 + start_epoch, 1 + max_epoch):
        ...
        rew, rew_std = test_result["NX_0_rew"], test_result["NX_0_rew_std"]
